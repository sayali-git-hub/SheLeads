...
const Cart = () => {
  ...
  const [cartItems, setCartItems] = useState([
    { id: 1, name: 'Floral Summer Dress', price: 59.99, quantity: 1, image: 'https://via.placeholder.com/100', size: 'M' },
    { id: 2, name: 'Classic White Blouse', price: 39.99, quantity: 2, image: 'https://via.placeholder.com/100', size: 'S' },
  ]);
